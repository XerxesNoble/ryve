...
ASSIGNMENT: spark sp-ux0021. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0021 in_progress`

Title: Close workshop confirmation dialog

Description:
Closing workshop with active terminals/agents is instant with no confirmation. Need a dialog: "Workshop has N active Hands. Close anyway?"
