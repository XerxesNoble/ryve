...
ASSIGNMENT: spark sp-ux0023. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0023 in_progress`

Title: Background picker: dim opacity slider + preview

Description:
Dim opacity is in config but not adjustable from UI. Add slider. Also add preview-on-hover before committing to a background image.
