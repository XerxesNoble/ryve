...
ASSIGNMENT: spark sp-ux0014. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0014 in_progress`

Title: Terminal font/size preferences

Description:
Terminal font is hardcoded to 14.0 monospace. Need: global font size setting, Cmd+scroll to resize, font family picker. Per-terminal override would be nice but global is the priority.
