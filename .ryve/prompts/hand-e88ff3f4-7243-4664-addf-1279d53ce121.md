...
ASSIGNMENT: spark sp-ux0032. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0032 in_progress`

Title: Smooth animations and transitions

Description:
All state changes are instant. Tab switch, workshop switch, file load, modal open — all jarring. Iced has limited animation support but crossfade and slide-in are possible with custom widgets.
