...
ASSIGNMENT: spark sp-ux0030. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0030 in_progress`

Title: Terminal search (Cmd+F in terminal)

Description:
RegexSearch is imported in backend.rs but not exposed. Wire it to a search UI overlay on the terminal.
