...
ASSIGNMENT: spark sp-ux0020. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0020 in_progress`

Title: File viewer breadcrumb path

Description:
Tab shows filename only. Need full breadcrumb path above content: workshop > src > screen > file_viewer.rs. Clickable segments to navigate to parent directories.
