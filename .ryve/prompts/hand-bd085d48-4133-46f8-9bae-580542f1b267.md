...
ASSIGNMENT: spark sp-ux0026. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0026 in_progress`

Title: Git status accessibility: add letters/icons alongside colors

Description:
Git status is communicated only by color (M/A/D/R). Colorblind users cannot distinguish states. Add text badges or icons: M, A, D, R, U, ?, C.
