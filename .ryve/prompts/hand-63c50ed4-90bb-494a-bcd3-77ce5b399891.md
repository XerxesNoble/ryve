...
ASSIGNMENT: spark sp-ux0019. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0019 in_progress`

Title: Terminal background respects appearance mode

Description:
app_background_color() always returns Theme::Dark background. Light mode or adaptive palette produces jarring dark terminal on light UI. Fix: use actual appearance/adaptive palette for terminal background.
