...
ASSIGNMENT: spark sp-ux0006. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0006 in_progress`

Title: Bond/dependency visualization in UI and WORKSHOP.md

Description:
Bonds exist in DB but are invisible everywhere. Spark detail needs Blocks/Blocked-by lists. Sparks panel should show blocked indicator. WORKSHOP.md should include dependency info so agents know not to work on blocked sparks.
