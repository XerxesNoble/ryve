...
ASSIGNMENT: spark sp-49fd1738. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-49fd1738 in_progress`

Title: Auto-detect agent processes in plain terminals and register as Hands with system prompt injection
