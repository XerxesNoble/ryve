...
ASSIGNMENT: spark sp-ux0024. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0024 in_progress`

Title: File explorer hover highlight

Description:
style::hovered_item() exists but is never used on file explorer rows. Wire it up for mouse hover feedback.
