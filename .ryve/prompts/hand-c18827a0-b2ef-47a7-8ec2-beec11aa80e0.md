...
ASSIGNMENT: spark sp-ux0027. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0027 in_progress`

Title: Reduce bottom-pin newline hack from 200 to 20

Description:
200 blank lines before shell prompt pollutes scrollback and is jarring on scroll-up. Reduce to 10-20 or implement proper scroll-to-bottom via iced_term.
