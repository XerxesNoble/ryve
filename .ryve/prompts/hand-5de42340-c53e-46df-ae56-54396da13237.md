...
ASSIGNMENT: spark sp-ux0029. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0029 in_progress`

Title: File viewer minimap

Description:
Condensed overview on right edge of file viewer. Requires custom canvas rendering of syntax-colored blocks.
