...
ASSIGNMENT: spark sp-ux0022. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0022 in_progress`

Title: Click-outside-to-dismiss dropdown menus

Description:
Bench + dropdown requires clicking the + button again to close. Need click-outside-to-dismiss behavior.
