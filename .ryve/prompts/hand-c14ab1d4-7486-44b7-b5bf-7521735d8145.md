...
ASSIGNMENT: spark sp-ux0012. You have been assigned this spark. Mark it in progress now: `ryve spark status sp-ux0012 in_progress`

Title: Find-in-file (Cmd+F) for file viewer

Description:
Raw content is stored in FileViewerState. Need search bar, highlight matching lines in viewport, next/prev navigation.
