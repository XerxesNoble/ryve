...
pub struct Tab {
    ...
    pub title: String,
    pub kind: TabKind,
    /// Pinned tabs are locked to the front of the tab bar. The Atlas
    /// tab uses this to guarantee it stays at index 0 — no other tab
    /// can be inserted or dragged to its left.
    pub pinned: bool,
}
